...
class ResNet_cifar(GenericModel):
    def __init__(self, block, num_blocks, args):
        super().__init__(args)
        self.in_planes = 16
        ...
        self.linear = nn.Linear(64*block.expansion, self.num_classes)
...
class WResNet_cifar(GenericModel):
    def __init__(self, block, num_blocks, k, args):
        super().__init__(args)
        self.in_planes = 16*k
        ...
        self.linear = nn.Linear(64*k*block.expansion, self.num_classes)
